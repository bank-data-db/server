...
func (a *API) TransactionsDelete(ctx context.Context, req *svc.ReqDelete) (*emptypb.Empty, error) {
	if req.GetID() == "" {
...
func (a *API) TransactionsNew(ctx context.Context, req *transactions.ReqNew) (*svc.RespNew, error) {
	panic("unimplemented")
}
