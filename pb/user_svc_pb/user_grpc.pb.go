...
type UserServiceClient interface {
	// Creates a token for the bank data service
	CreateToken(ctx context.Context, in *ReqLogin, opts ...grpc.CallOption) (*RespLogin, error)
}
...
func (c *userServiceClient) CreateToken(ctx context.Context, in *ReqLogin, opts ...grpc.CallOption) (*RespLogin, error) {
...
type UserServiceServer interface {
	// Creates a token for the bank data service
	CreateToken(context.Context, *ReqLogin) (*RespLogin, error)
...
func (UnimplementedUserServiceServer) CreateToken(context.Context, *ReqLogin) (*RespLogin, error) {
...
func _UserService_CreateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CreateToken(ctx, req.(*ReqLogin))
	}
